...
| scorecard | Optional             | **triaged**  | **6.0** @ `a98e062` (MT-W14); Pinned-Dependencies **10/10** (MT-W14a); OSV triage **done** (MT-W14b); Vulnerabilities re-run pending — `scorecard-gaps.md` |
