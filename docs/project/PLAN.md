...
| Playwright CI | **partial** — stub GHA (`e2e-playwright`); cluster MT-E2E manual — `baseline-smoke.md` two-tier policy                         |
...
| Playwright CI     | **partial** — stub `e2e-playwright` GHA (DRL-001 layout); cluster MT-E2E manual — `CAISAT_GPU_EXCLUSIVE=1 node scripts/mt-e2e-workflow.mjs` |
